...
if [[ "$ENVIRONMENT" != "prod" ]]; then
  REQUIRED_APK_VERSION_CODE="${BRIGHT_OS_REQUIRED_APK_VERSION_CODE:-${BRIGHT_OS_MIN_APK_VERSION_CODE:-$("$NODE_BIN" "$SCRIPT_DIR/resolve-required-apk-version-code.mjs" "$ENVIRONMENT")}}"
