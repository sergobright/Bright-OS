...
- 2026-06-13: Generated an SSH deploy key for `sergobright/Bright-OS`, switched `origin` to SSH, and configured local Git to use that key.
...
- Add the generated public deploy key to GitHub with write access, then run `git push -u origin main`.
